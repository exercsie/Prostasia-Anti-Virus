...
Prostasia:
	g++ Main/ProcessMonitor/Monitor.cpp Main/ProstasiaUI/Main.cpp Main/ProstasiaUI/Menu.cpp Main/RunningProcesses.cpp Main/Vector.cpp Main/Alerts.cpp -o Main/ProstasiaUI/Prostasia $(PROSTASIA_FLAGS)
